...
short_description: Manipulate the configuration of a Control-M Agent on a Windows host
author:
...
options:
    ...
    logical_agent_name:
        description:
            ...
            - The default value is the C(Agent host name).
        type: str
    ...
    listen_to_network_interface:
        description:
            ...
            - If this parameter is set to C(*ANY), the agent is listening on all available interfaces.
        default: \*ANY
        type: str
    ctms_address_mode:
        description:
...
config:
    ...
    contains:
        ...
        primary_controlm_server_host:
            ...
            type: str
        server_agent_protocol_version:
            description: Version of the server-Agent communication protocol.
            returned: success
            type: int
            sample: 12
        run_user_logon_script:
        ...
        job_output_name:
            ...
            sample: JOBNAME
        tcpip_timeout:
            description: Timeout of the Communication job-tracking in seconds.
            returned: success
            type: int
            sample: 60
        timeout_for_agent_utilities:
        ...
        tracker_event_port:
            ...
            sample: 7035
        tracker_polling_interval:
            description: Timeout of the tracker event in seconds.
            returned: success
            type: int
            sample: 60
        wrap_parameters_with_double_quotes:
